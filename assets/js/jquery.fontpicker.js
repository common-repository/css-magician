...
(function($){
	...
	var googleFontCats = ['serif', 'sans-serif', 'display', 'handwriting', 'monospace', 'icons'];
	...
	$.fn.fontpicker = function(options) {
		...
		var dictionaries = {
			...
			'fr': {
				...
				'googleFonts': 'Polices de Google',
				'select': 'Sélectionner',
				'styles': 'Styles',
				'sampleText': 'Le rapide renard brun saute par-dessus le chien paresseux.',
				'sampleTextEditable': 'Exemple de texte, editable'
			}
		};
		...
		var settings = {
			...
			nrRecents: 5, // How many recently picked fonts to remember (shown in 'Favorite fonts' section)
					...
					var observer = new IntersectionObserver(function(lis) {
						[].forEach.call(lis, function(li) {
							if (li.intersectionRatio > 0) {
								...
								if($li.data('font-family')!='Material Icons' && $li.data('font-family')!='fontawesome-webfont')
