...
<html>
  <head>
    ...
    <title>Css Magician Transparent Text Widget Help</title>
  </head>
  <body>
    <h1  style=" text-align: center;"><span  style="font-family: Impact;"><?php echo _e('TRANSPARENT TEXT WIDGET' , 'css-magician'); ?></span></h1><br>
    <span><?php echo _e('Nothing particular to say here. All is intuitive.' , 'css-magician'); ?></span><br><br>
