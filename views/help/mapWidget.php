...
<html>
  <head>
    ...
    <title>Css Magician Google Map Widget Help</title>
  </head>
  <body>
    <h1  style=" text-align: center;"><span  style="font-family: Impact;"><?php echo _e('GOOGLE MAP WIDGET' , 'css-magician'); ?></span></h1>
    <span><?php echo _e('Nothing particular to say here.' , 'css-magician'); ?></span><br><br>
    <span><?php echo _e('When you do an update, it is necessary to wait for the Googgle API return the result.' , 'css-magician'); ?></span><br><br>
