...
<head>
  ...
  <title>Stylizer Transform</title>
</head>

<body>
  <h1 style=" text-align: center;"><span style="font-family: Impact;"><?php echo _e('Transform' , 'css-magician'); ?></span></h1>
  </span><br>
  <span style="text-align: left;"> <span style="font-weight: bold; color:green;"><?php echo _e('TRANSFORM' , 'css-magician'); ?></span><br>
    <br>
    <span><?php echo _e('Nothings particular to say here.' , 'css-magician'); ?></span><br>
    <span><?php echo _e('The transform CSS property lets you rotate, scale, skew, or translate an element. It modifies the coordinate space of the CSS.' , 'css-magician'); ?></span><br> <br>
