...
<head>
  ...
  <title>Css Magician Custom Coundown Widget</title>
</head>

<body>
  <h1 style=" text-align: center;"><span style="font-family: Impact;"><?php echo _e('CUSTOM COUNTDOWN WIDGET' , 'css-magician'); ?></span></h1>
