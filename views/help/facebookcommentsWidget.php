...
<html>
  <head>
    ...
    <title>Css Magician Facebook Comment Widget</title>
  </head>
  <body>
    <h1  style=" text-align: center;"><span  style="font-family: Impact;"><?php echo _e('FACEBOOK COMMENTS WIDGET' , 'css-magician'); ?></span></h1>
    ...
    <span><?php echo _e('Width (%): As indicated the width is in percent.' , 'css-magician'); ?></span><br><br>
