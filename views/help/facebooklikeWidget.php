...
<html>
  <head>
    ...
    <title>Css Magician Facebook Like Widget</title>
  </head>
  <body>
    <h1  style=" text-align: center;"><span  style="font-family: Impact;"><?php echo _e('FACEBOOK LIKE WIDGET' , 'css-magician'); ?></span></h1>
