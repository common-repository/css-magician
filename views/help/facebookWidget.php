...
<html>
  <head>
    ...
    <title>Css Magician Facebook Widget</title>
  </head>
  <body>
    <h1  style=" text-align: center;"><span  style="font-family: Impact;"><?php echo _e('FACEBOOK WIDGET' , 'css-magician'); ?></span></h1>
    ...
    <span><?php echo _e('Width: The minimum width of facebook widget is 180px. So, do not add an inferior width.' , 'css-magician'); ?></span><br><br>
    <span><?php echo _e('For the width and height, when you do an update, it is necessary to wait for the facebook API return the result.' , 'css-magician'); ?></span><br><br>
