...
<head>
  ...
  <title>Stylizer Shadow</title>
</head>

<body>
  <h1 style=" text-align: center;"><span style="font-family: Impact;"><?php echo _e('Box Shadow' , 'css-magician'); ?></span></h1>
  </span><br>
  <span style="text-align: left;"> <span style="font-weight: bold; color:green;"><?php echo _e('Box Shadow' , 'css-magician'); ?></span><br>
    <br>
    <span><?php echo _e('The four fields have to be validated to see something' , 'css-magician'); ?></span><br><br>
