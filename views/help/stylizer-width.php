...
<head>
  ...
  <title>Stylizer Width/Height</title>
</head>

<body>
  <h1 style=" text-align: center;"><span style="font-family: Impact;"><?php echo _e('Width/Height' , 'css-magician'); ?></span></h1>
  </span><br>
  <span style="text-align: left;"> <span style="font-weight: bold; color:green;"><?php echo _e('Width/Height' , 'css-magician'); ?></span><br>
    <br>
    <span><?php echo _e('The Width and Height units are by default define in percentage to be responsive.' , 'css-magician'); ?></span><br>
    <span><?php echo _e('If you validate the Pixels checkbox, the unit will be in pixels.' , 'css-magician'); ?></span><br> <br>
