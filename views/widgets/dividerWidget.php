...
?>
<div id="vmutc_dividerContainer" class="vmutc_widgetWindow">
	<div class="vmutc_svg_select_container col-lg-12">
		<div class="vmutc_svg_button_position_container">
			<button id="vmutc_dividerWidget_bottom_button" class="btn btn-secondary"> <?php echo _e('BOTTOM' , 'css-magician'); ?></button>
			<button id="vmutc_dividerWidget_top_button" class="btn btn-secondary active"> <?php echo _e('TOP' , 'css-magician'); ?></button>
		</div>
		<fieldset class="form-group">
			<label class="form-control-label" for=""><?php echo _e('Shape Style' , 'css-magician'); ?></label><br />
			<div id="vmutc_editorDividerStyleChoose" class="">
	  		<input id="cssm-divider-menu-toggle" type="checkbox">
				<label id="cssm-divider-menu-label" class="btn btn-primary" for="cssm-divider-menu-toggle"> <?php echo _e('Select a button style' , 'css-magician'); ?><i class="fas"></i></label>

				<ul class="collapse-menu">
					<li class="vmutc_svg_select vmutc_svg_select_none" data-name="none">
						<span class="">None</span>
					</li>
					<li class="vmutc_svg_select" data-name="triangle1">
						<svg fill="#5aa8ec" preserveAspectRatio="none" style="height: 30px; margin-top: 10px; " class="svg_divider_rotateXY" viewBox="0 0 1300 140">
							<path d="M0 0v140h1300L0 0z"></path>
						</svg></li>
					</li>
					<li class="vmutc_svg_select" data-name="triangle2">
						<svg fill="#5aa8ec" preserveAspectRatio="none" style="height: 30px; margin-top: 20px; " class="svg_divider_rotateXY" viewBox="0 0 1300 140">
							<path d="M0 0v140h1300L0 0z" fill-opacity=".5"></path>
							<path d="M0 42v98h1300L0 42z"></path>
						</svg>
					</li>
					</li>
					<li class="vmutc_svg_select" data-name="triangle3">
						<svg fill="#5aa8ec" preserveAspectRatio="none" style="height: 30px; margin-top: 20px; " class="svg_divider_rotateXY" viewBox="0 0 1300 140">
							<path d="M640 139L0 0v140h1300V0L640 139z"></path>
						</svg>
					</li>
					</li>
					<li class="vmutc_svg_select" data-name="triangle4">
						<svg fill="#5aa8ec" preserveAspectRatio="none" style="height: 30px; margin-top: 20px; " class="svg_divider_rotateXY" viewBox="0 0 1300 140">
					...
					<li class="vmutc_svg_select" data-name="triangle5">
						<svg fill="#5aa8ec" preserveAspectRatio="none" style="height: 30px; margin-top: 20px; " class="svg_divider_rotateXY" viewBox="0 0 1300 140">
							<path d="M0,140l650-70l650,70V0L650,70L0,0V140z" fill-opacity=".5" />
							<path d="M0,140h1300L640,70L0,140z" />
						</svg>
					</li>
					<li class="vmutc_svg_select" data-name="triangle6">
						<svg class="svg_divider_rotateXY vmutc_divider_top" fill="#5aa8ec" preserveAspectRatio="none" style="height: 30px; margin-top: 10px;" viewbox="0 0 1300 140">
							<g>
								<path fill-opacity="0.4" d="M1300,139.5H0V57.4L650,0.5l650,56.9V139.5z" />
								<path d="M650,0.5L0,57.4v82.1h650V0.5z" />
							</g>
						</svg>
					</li>
					<li class="vmutc_svg_select" data-name="triangle7">
						<svg class="svg_divider_rotateXY vmutc_divider_top" fill="#5aa8ec" preserveAspectRatio="none" style="height: 30px; margin-top: 10px;" viewBox="0 0 1300 140">
					...
					<li class="vmutc_svg_select" data-name="arrondi1">
						<svg fill="#5aa8ec" preserveAspectRatio="none" style="height: 30px; margin-top: 20px; " class="svg_divider_rotateXY" viewBox="0 0 1300 140">
							<path d="M0 140h1300C573.08 140 0 0 0 0z"></path>
						</svg>
					</li>
					<li class="vmutc_svg_select" data-name="arrondi2">
						<svg fill="#5aa8ec" preserveAspectRatio="none" style="height: 30px; margin-top: 20px; " class="svg_divider_rotateXY" viewBox="0 0 1300 140">
					...
					<li class="vmutc_svg_select" data-name="arrondi3">
						<svg fill="#5aa8ec" preserveAspectRatio="none" style="height: 30px; margin-top: 20px; " class="svg_divider_rotateXY" viewBox="0 0 1300 140">
							<path d="M1300 140V0S993.46 140 640 139 0 0 0 0v140z"></path>
						</svg>
					</li>
					<li class="vmutc_svg_select" data-name="arrondi4">
						<svg fill="#5aa8ec" preserveAspectRatio="none" style="height: 30px; margin-top: 20px; " class="svg_divider_rotateXY" viewBox="0 0 1300 140">
							<path d="M725.3,101.2C325.2,122.5,0,0,0,0v140h1300V0c0,0-154.6,79.9-554.7,101.2H725.3z" fill-opacity=".3" />
							<path d="M556.5,119.7C953.4,140,1300,14,1300,14v126H0V0C0,0,159.5,99.5,556.5,119.7z" fill-opacity=".5" />
							<path d="M690.6,139.5c336.6,0,609.4-140,609.4-139v140H0v-141c0,0,272.8,140,609.4,140H690.6z" />
						</svg>
					</li>
					<li class="vmutc_svg_select" data-name="arrondi5">
						<svg class="svg_divider_rotateXY vmutc_divider_top" fill="#5aa8ec" preserveAspectRatio="none" style="height: 30px; margin-top: 10px;" viewbox="0 0 1300 140">
							<path d="M1300,110v30H0v-30C0,110,208.6,0,650,0S1300,110,1300,110z" />
						</svg>
					</li>
					<li class="vmutc_svg_select" data-name="arrondi6">
						<svg class="svg_divider_rotateXY vmutc_divider_top" fill="#5aa8ec" preserveAspectRatio="none" style="height: 30px; margin-top: 10px;" viewbox="0 0 1300 140">
							<path fill-opacity="0.4" d="M1300,139v-12.8c0,0-230.1-125.7-650-125.7S0,125.1,0,125.1V139H1300z" />
							<path fill-opacity="0.6" d="M1300,139.5v-13.3c0,0-230.1-97.5-650-97.5S0,125.1,0,125.1v14.4H1300z" />
							<path d="M1300,139.5v-13.3c0,0-230.1-67.9-650-67.9S0,125.1,0,125.1v14.4L1300,139.5z" />
						</svg>
					</li>
					<li class="vmutc_svg_select" data-name="arrondi7">
						<svg class="svg_divider_rotateXY vmutc_divider_top" fill="#5aa8ec" preserveAspectRatio="none" style="height: 30px; margin-top: 10px;" viewbox="0 0 1300 140">
							<path fill-opacity="0.4" d="M0,96.5V140h1300V36.8c-378.3,0-341.9,60.6-578.5,60.6c-194.1,0-195.3-22.8-298-22.8h-11.2C218,74.6,197.9,142.4,0,96.5L0,96.5z" />
							<path fill-opacity="0.4" d="M0,96.5V140h1300V18.4c-378.3,0-341.9,79-578.5,79c-194.1,0-195.3-22.8-298-22.8h-11.2C299,74.6,193.4,143.1,0,96.5z" />
							<path d="M0,96.5c230.7,53.1,338-21.9,423.5-21.9c102.7,0,103.9,22.8,298,22.8C958.1,97.4,921.7,0,1300,0v140H0V96.5z" />
						</svg>
					</li>
					<li class="vmutc_svg_select" data-name="arrondi8">
						<svg class="svg_divider_rotateXY vmutc_divider_top" fill="#5aa8ec" preserveAspectRatio="none" style="height: 30px; margin-top: 10px;" viewbox="0 0 1300 140">
							<path fill-opacity="0.4" d="M643.1,92.8C850.1,92.8,993.7,5,1300,5v135H639.6L643.1,92.8z" />
							<path fill-opacity="0.6" d="M669.1,92.8c207,0,324.6-67.8,630.9-67.8l0,115H669.1V92.8z" />
							<path fill-opacity="0.8" d="M669.1,92.4c8.2,0.2,16.8,0.3,26,0.3c207,0,298.6-51.9,604.9-51.9V140H669.1V92.4z" />
							<path d="M1300,40.9V140H0v-24.7c276.4,0,281.5-52.3,383-52.3c75.3,0,94.2,29.8,338.1,29.8c207,0,272.6-26.8,578.9-26.8V40.9z" />
						</svg>
					</li>
					<li class="vmutc_svg_select" data-name="arrondi9">
						<svg class="svg_divider_rotateXY vmutc_divider_top" fill="#5aa8ec" preserveAspectRatio="none" style="height: 30px; margin-top: 10px;" viewbox="0 0 1300 140">
							<path class="st0" d="M650,82.8c0,0-29.8-82.8-187.7-82.8H0v140h1300V0H837.7C679.8,0,650,82.8,650,82.8L650,82.8z" />
						</svg>
					</li>
					<li class="vmutc_svg_select" data-name="montagne1">
						<svg fill="#5aa8ec" preserveAspectRatio="none" style="height: 30px; margin-top: 20px; " class="svg_divider_rotateXY" viewBox="0 0 1300 140">
							<path class="st0" d="M0,70.3l325-49.2l650,98.5l325-49.3V140H0V70.3z" />
						</svg></li>
					<li class="vmutc_svg_select" data-name="montagne2">
						<svg fill="#5aa8ec" preserveAspectRatio="none" style="height: 30px; margin-top: 20px; " class="svg_divider_rotateXY" viewBox="0 0 1300 140">
							<path class="st0" d="M0,47.4L172.7,0l636.3,94.9l318.4-7.8L1300,47.4V140H0V47.4z" fill-opacity=".5" />
							<path class="st1" d="M0,90.7l142.2-28.3l320.4,24.1l346.3-20.8l348.9,39.1L1300,90.7V140H0V90.7z" />
						</svg></li>
					<li class="vmutc_svg_select" data-name="montagne3">
						<svg fill="#5aa8ec" preserveAspectRatio="none" style="height: 30px; margin-top: 20px; " class="svg_divider_rotateXY" viewBox="0 0 1300 140">
							<path d="M0 122.138l60.614 9.965 95.644-4.2 86.363-18.654 78.684 13.079L411.442 99.4l94.453 10.303L582.821 93.8l82.664 18.728 76.961-11.39L816.11 71.4l97.601 9.849L997.383 50.4l66.285 14.694 70.793-24.494h79.863L1300 0v140H0z">
							</path>
						</svg></li>
					<li class="vmutc_svg_select" data-name="montagne4">
						<svg fill="#5aa8ec" preserveAspectRatio="none" style="height: 30px; margin-top: 20px; " class="svg_divider_rotateXY" viewBox="0 0 1300 140">
							<path d="M0 127.899l60.613 4.878 95.645-6.211 86.363-16.074 78.684 9.883 90.136-21.594 94.454 7.574 77.925-17.66 91.664 20.798 76.961-12.649 63.664-21.422 97.602 7.07 83.672-29.617 66.285 11.678 70.793-23.334 74.863-4.641L1300 0v140H0z" fill-opacity=".5"></path>
							<path d="M0 126.71l60.613 7.415L156.257 131l86.364-13.879 78.683 9.731 90.137-17.059 94.453 7.666 76.926-11.833 82.664 13.935 76.961-8.475 73.664-22.126 97.601 7.328 83.672-22.952 66.285 10.933 70.794-18.224h79.862L1300 35.838V140H0z">
							</path>
						</svg></li>
					<li class="vmutc_svg_select" data-name="montagne5">
						<svg fill="#5aa8ec" preserveAspectRatio="none" style="height: 30px; margin-top: 20px; " class="svg_divider_rotateXY" viewBox="0 0 1300 140">
							<path class="st0" d="M0,0l65.8,38.7l92.6-3.2l96.9,34.8l121.9,0.2l72.6,33.3l91.5-3.9L650,137.6l104-37.2l86.9,10.7l89.5-7.2l77.1-38.7l74.4,5.3l67.8-22.1l78.2-0.4L1300,0v140H0V0z" />
						</svg></li>
					<li class="vmutc_svg_select" data-name="montagne6">
						<svg fill="#5aa8ec" preserveAspectRatio="none" style="height: 30px; margin-top: 20px; " class="svg_divider_rotateXY" viewBox="0 0 1300 140">
							<path d="M0 0l64.8 30.95 91.2-2.54 95.46 27.87 120.04.2L443 83.15l90.09-3.12L640 110.12l102.39-29.73 85.55 8.51 88.11-5.75L992 52.22l73.21 4.26L1132 38.79l77-.33L1300 0v140H0V0z" fill-opacity=".5"></path>
							<path d="M0 0l64.8 38.69 91.2-3.18 95.46 34.84 120.04.24 71.5 33.35 90.09-3.91L640 137.65l102.39-37.17 85.55 10.65 88.11-7.19L992 65.28l73.21 5.31 66.79-22.1 77-.41L1300 0v140H0V0z">
							</path>
						</svg></li>
					<li class="vmutc_svg_select" data-name="montagne7">
						<svg class="svg_divider_rotateXY vmutc_divider_top" fill="#5aa8ec" preserveAspectRatio="none" style="height: 30px; margin-top: 10px;" viewbox="0 0 1300 140">
							<linearGradient gradientUnits="userSpaceOnUse" x1="0" y1="72.0075" x2="1300" y2="72.0075" gradientTransform="matrix(1 0 0 -1 0 142)">
							...
							<path d="M1300,69.7l-102.9-15.4l-90.6,18l-68.4-24L909,80.9l-61-8.7L742.8,0L511.5,64.8l-216.3-56L163,57.1l-55-40.3L0,71.7V140h1300V69.7z" />
							<linearGradient gradientUnits="userSpaceOnUse" x1="1300" y1="61.0025" x2="1.818989e-12" y2="61.0025" gradientTransform="matrix(1 0 0 -1 0 142)">
								<stop offset="0" style="stop-color:#DA1C5C" />
								<stop offset="8.000000e-02" style="stop-color:#CD1E62" />
								<stop offset="0.22" style="stop-color:#AC2371" />
								<stop offset="0.41" style="stop-color:#762B8A" />
							...
							<path d="M0,88.2l108.2-54l75.1,57.4l132.6-47.3l169,42L715,22l80.6,52.9l136.5,18.5l126.1-30l67.6,24l97.5-20l76.7,10V140H0V88.2L0,88.2z" />
						</svg>
					</li>
					<li class="vmutc_svg_select" data-name="montagne8">
						<svg class="svg_divider_rotateXY vmutc_divider_top" fill="#5aa8ec" preserveAspectRatio="none" style="height: 30px; margin-top: 10px;" viewbox="0 0 1300 140">
							<path fill-opacity="0.4" d="M0.4,64.1c0,0,1.8-9.2,3.6-11.4l8.7-1c0.1-3.5,5.8-6.4,11.3-5.8c4.9,0.6,8.8,3.6,13.8,3.7
...
c6.9,1.5,14.3,1.1,20.9-1.2c1.4-0.6,3-1,4.5-1.2c1.3,0.1,2.6,0.3,3.6,0.7c6.1,1.9,17.7,12.3,23.8,14.2l0.8,94.2H0L0.4,64.1z" />
							<g transform="translate(-110 81.23)">
								<linearGradient gradientUnits="userSpaceOnUse" x1="865.5342" y1="126.8571" x2="873.8875" y2="-32.6294" gradientTransform="matrix(1 0 0 -1 -110 60.77)">
									<stop offset="0" style="stop-color:#DCDDDE" />
									<stop offset="1" style="stop-color:#231F20" />
								</linearGradient>
								<path fill-opacity="0.6" d="M110-18.9c3.5-0.3,6.5-1.8,8.3-4.1l8.7-1c0.1-3.5,5.8-6.4,11.3-5.8c4.9,0.6,8.8,3.6,13.8,3.7
	...
	c6.9,1.5,14.3,1.1,20.9-1.2c1.4-0.6,3-1,4.5-1.2c1.3,0.1,2.6,0.3,3.6,0.7c6.1,1.9,19.1,2.3,19.1,14.2v88.7H110V-18.9L110-18.9z" />
								<linearGradient gradientUnits="userSpaceOnUse" x1="862.7376" y1="112.6305" x2="877.3633" y2="-54.4777" gradientTransform="matrix(1 0 0 -1 -110 60.77)">
	...
	L1409.6-2.5z" />
								<linearGradient gradientUnits="userSpaceOnUse" x1="864.9923" y1="111.3059" x2="875.8112" y2="-43.3409" gradientTransform="matrix(1 0 0 -1 -110 60.77)">
									<stop offset="0.23" style="stop-color:#E6E7E8" />
									<stop offset="0.66" style="stop-color:#C7C8CA" />
								</linearGradient>
								<path fill-opacity="0.8" d="M1409.9-11.1c-20.1,0.3-40.3-0.1-60.3-1.1c-3.5,0.8-7.3,1.3-11,1.4c-11.7,0.5-23.4-0.2-34.6-2.1
...
s-5.3,0.7-8.1,0.4c-4.3-0.5-8.1-3.1-12.3-2.4c-1.3,0.3-2.6,0.8-3.8,1.4C19.1,48.6,8.7,52.8,0.4,57L0.4,57z" />
					...
					<li class="vmutc_svg_select" data-name="vague1">
						<svg fill="#5aa8ec" preserveAspectRatio="none" style="height: 30px; margin-top: 20px; " class="svg_divider_rotateXY" viewBox="0 0 1300 140">
							<path class="st0" d="M325,28c325,0,325,84,650,84c162.5,0,243.8-21,325-42v70H0V70C81.3,49,162.5,28,325,28z" />
						</svg></li>
					<li class="vmutc_svg_select" data-name="vague2">
						<svg fill="#5aa8ec" preserveAspectRatio="none" style="height: 30px; margin-top: 20px; " class="svg_divider_rotateXY" viewBox="0 0 1300 140">
							<path fill-opacity=".3" d="M1300,88.2c-36.8,2.3-78.8,3.6-128.4,3.6c-325,0-325-57-650-57C246.2,34.8,204.1,75.7,0,88.2L0,140h1300V88.2z" />
							<path fill-opacity=".5" d="M1300,115.2c-44.1,5.7-96,9.3-160.9,9.3c-325,0-325-89.2-650-89.2C229,35.3,177,92.5,0,115.3l0,24.2h1300V115.2z" />
							<path d="M1300,139.5v-3.4c-28.6,1.8-60.3,2.8-95.9,2.8c-325,0-325-84.3-650-84.3C264.7,54.6,233,121.5,0,136.1l0,3.4H1300z" />
						</svg></li>
					<li class="vmutc_svg_select" data-name="vague3">
						<svg fill="#5aa8ec" preserveAspectRatio="none" style="height: 30px; margin-top: 20px; " class="svg_divider_rotateXY" viewBox="0 0 1300 140">
							<path d="M1300 86c-19.9-17.21-40.08-39.69-79.89-39.69-57.49 0-56.93 46.59-115 46.59-53.61 0-59.76-39.62-115.6-39.62C923.7 53.27 924.26 87 853.89 87c-89.35 0-78.74-87-188.2-87C554 0 543.95 121.8 423.32 121.8c-100.52 0-117.84-54.88-191.56-54.88-77.06 0-100 48.57-151.75 48.57-40 0-60-12.21-80-29.51v54H1300z">
							</path>
						</svg></li>
					<li class="vmutc_svg_select" data-name="vague4">
						<svg fill="#5aa8ec" preserveAspectRatio="none" style="height: 30px; margin-top: 20px; " class="svg_divider_rotateXY" viewBox="0 0 1300 140">
	...
	c-3.7-1.2-4.8-5.6-5.3-9.3L28,60c-0.9-6.3,0.3-27.7-15-24.4c-14.1,3,7.1,60.9-13,60.9V140h1300V96.7z" />
					...
					<li class="vmutc_svg_select" data-name="nuage4">
						<svg class="svg_divider_rotateXY vmutc_divider_top" fill="#5aa8ec" preserveAspectRatio="none" style="height: 30px; margin-top: 10px;" viewbox="0 0 1300 140">
	...
	c0,0,3.5-13.8-7.8-11.9c0,0,10.4-16,10.4-32.5s-33.8-37.3-67.6-19c0,0-43.1-46.3-123.4-14.6V140h1300V21.7z" />
					...
					<li class="vmutc_svg_select" data-name="nuage5">
						<svg class="svg_divider_rotateXY vmutc_divider_top" fill="#5aa8ec" preserveAspectRatio="none" style="height: 30px; margin-top: 10px;" viewBox="0 0 1300 140">
	...
	S20.3,60.9,0,139H1300z" />
					...
					<li class="vmutc_svg_select" data-name="nuage6">
						<svg class="svg_divider_rotateXY vmutc_divider_top" fill="#5aa8ec" preserveAspectRatio="none" style="height: 30px; margin-top: 10px;" viewbox="0 0 1300 140">
	...
	<fieldset class="vmutc_buttonSettingsContainer">
		<div class="form-group vmutc-widgetValues">
			<label class="control-label">
				<span class="label-tooltip" data-toggle="tooltip" data-html="true"  ><?php echo _e('Divider Color' , 'css-magician'); ?></span>
			</label>
			<input type="text" name="vmutc_dividerWidget_BackgroundColor" id="vmutc_dividerWidget_BackgroundColor">
		</div>
		<div id="vmutc_dividerWidget_width_container">
			<label class="control-label">
				<span class="label-tooltip" data-toggle="tooltip" data-html="true"  ><?php echo _e('Divider Width' , 'css-magician'); ?></span>
			</label>
			<div id="vmutc_dividerWidget_width_slider" class="section_slider_width"></div>
			<input type="text" name="vmutc_dividerWidget_width" id="vmutc_dividerWidget_width" class="vmutc_editorInput vmutc_numeric inputAlign">
		</div>
		<div id="vmutc_dividerWidget_height_container">
			<label class="control-label">
				<span class="label-tooltip" data-toggle="tooltip" data-html="true"  ><?php echo _e('Divider Height' , 'css-magician'); ?></span>
			</label>
			<div id="vmutc_dividerWidget_height_slider" class="section_slider_width"></div>
			<input type="text" name="vmutc_dividerWidget_height" id="vmutc_dividerWidget_height" class="vmutc_editorInput vmutc_numeric inputAlign">
		</div>
		<span class="label-tooltip" data-toggle="tooltip" data-html="true"  > <?php _e('Horizontal Flip','css-magician');?></span>
                <div class="slideThree">
                    <input type="checkbox" value="" id="vmutc_dividerWidget_flip" name="vmutc_dividerWidget_flip" />
                    <label for="vmutc_dividerWidget_flip"></label>
                </div>
	</fieldset>
