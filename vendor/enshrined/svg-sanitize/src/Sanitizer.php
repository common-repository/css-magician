...
require_once CSSM_PLUGIN_DIR_PATH . 'vendor/enshrined/svg-sanitize/src/ElementReference/Resolver.php';
require_once CSSM_PLUGIN_DIR_PATH . 'vendor/enshrined/svg-sanitize/src/ElementReference/Subject.php';
